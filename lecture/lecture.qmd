...
! sf utilise la géométrie sphérique par défaut pour les données non projetées depuis la version 1.0 grâce a la librairie `s2`. Voir (https://r-spatial.github.io/sf/articles/sf7.html)[https://r-spatial.github.io/sf/articles/sf7.html] pour plus de détails.
